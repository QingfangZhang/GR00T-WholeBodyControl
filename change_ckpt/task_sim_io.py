"""I/O helpers for the checkpoint-comparison MuJoCo simulator.
...
def stage_recording_snapshot(
    ...
    if destination_parent is None:
        temporary = tempfile.TemporaryDirectory(prefix="change_ckpt_task_sim_")
...
class ReplayCsvWriter:
    ...
    def __init__(
        ...
        # copy the completed replay into the requested change_ckpt/data run.
        self._spool_directory = tempfile.TemporaryDirectory(
            prefix="change_ckpt_replay_csv_"
        )
